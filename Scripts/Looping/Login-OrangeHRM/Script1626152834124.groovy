...
if (GlobalVariable.username == 'Random') {
    WebUI.setText(findTestObject('Orange-HRM/OrangeHRM-Login/username'), faker.name().username())
} else {
    WebUI.setText(findTestObject('Orange-HRM/OrangeHRM-Login/username'), GlobalVariable.username)
}
