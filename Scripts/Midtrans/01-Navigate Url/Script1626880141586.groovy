...
WebUI.verifyLinksAccessible(['https://demo.midtrans.com/'])

WebUI.verifyElementVisible(findTestObject('Midtrans/txt_verifyTitle'))

WebUI.verifyElementVisible(findTestObject('Midtrans/lbl_verifyTitle'))
