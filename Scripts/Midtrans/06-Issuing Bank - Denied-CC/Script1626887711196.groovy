...
WebUI.verifyElementVisible(findTestObject('Midtrans/txt_password'))

WebUI.click(findTestObject('Midtrans/btn-ib-ok'))

WebUI.delay(2)

WebUI.switchToFrame(findTestObject('Midtrans/lbl-denied-cc'), 5)

WebUI.verifyElementVisible(findTestObject('Midtrans/lbl-failed-deniedcc'))
