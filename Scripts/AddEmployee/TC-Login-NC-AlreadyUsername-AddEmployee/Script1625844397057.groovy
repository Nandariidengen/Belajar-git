...
WebUI.setText(findTestObject('Orange-HRM/OrangeHRM-PIM-AddEmployee/txt_FirstName'), 'Nanda')
...
WebUI.setText(findTestObject('Orange-HRM/OrangeHRM-PIM-AddEmployee/txt_Username'), 'nandarii')
...
WebUI.verifyElementPresent(findTestObject('Orange-HRM/OrangeHRM-PIM-AddEmployee/txt_VerifyErrorMessage'), 10)
