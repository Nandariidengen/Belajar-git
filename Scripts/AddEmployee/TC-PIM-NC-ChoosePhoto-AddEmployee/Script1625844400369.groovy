...
WebUI.setText(findTestObject('Orange-HRM/OrangeHRM-PIM-AddEmployee/txt_EmployeeId'), '00145')

WebUI.uploadFile(findTestObject('Orange-HRM/OrangeHRM-PIM-AddEmployee/Photo'), ppt)
